...
namespace GMKN.Dnn.map_modul.Controllers
{
    ...
    public class SettingsController : DnnController
    {
        ...
        {
            ModuleContext.Configuration.ModuleSettings["map_modul_Setting1"] = settings.Setting1.ToString();
            ModuleContext.Configuration.ModuleSettings["map_modul_Setting2"] = settings.Setting2.ToUniversalTime().ToString("u");
